...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i7.IMessBalanceRepositoryFacade>(
        () => _i8.MessBalanceRepository(
              gh<_i4.FirebaseFirestore>(),
              gh<_i3.FirebaseAuth>(),
            ));
    gh.lazySingleton<_i9.IMessDetailsRepositoryFacade>(
    ...
    gh.factory<_i19.InternetStatus>(() => _i19.InternetStatus());
    gh.factory<_i20.MessBalanceRepositoryBloc>(() =>
        _i20.MessBalanceRepositoryBloc(gh<_i7.IMessBalanceRepositoryFacade>()));
    gh.factory<_i21.MessDetailsBloc>(
        () => _i21.MessDetailsBloc(gh<_i9.IMessDetailsRepositoryFacade>()));
    gh.factory<_i22.MessReallocationBloc>(() => _i22.MessReallocationBloc(
        gh<_i11.IMessReallocationRepositoryFacade>()));
    gh.factory<_i23.MessReallocationRequestBloc>(
        () => _i23.MessReallocationRequestBloc(gh<_i17.IUserDataFacade>()));
    gh.factory<_i24.MessRegistrationBloc>(() => _i24.MessRegistrationBloc(
        gh<_i13.IMessRegistrationRepositoryFacade>()));
    gh.factory<_i25.MessUserInfoBloc>(
        () => _i25.MessUserInfoBloc(gh<_i15.IMessUserInfoFacade>()));
    gh.factory<_i26.SignInBloc>(() => _i26.SignInBloc(gh<_i5.IAuthFacade>()));
    gh.factory<_i27.UserRepositoryBloc>(() => _i27.UserRepositoryBloc(
          gh<_i17.IUserDataFacade>(),
          gh<_i19.InternetStatus>(),
        ));
    gh.factory<_i28.AuthBloc>(() => _i28.AuthBloc(gh<_i5.IAuthFacade>()));
    return this;
  }
}
